...
/**
 * This is the model which encapsulates the Domain model of Competency (which is different from DB model). Currently
 * taxonomy courses are not considered in model. Also note that this does not encapsulate the enriched model to provide
 * more information like competency title, domain name etc.
 *
 * @author ashish.
 */
