...
class SkippedItemsCalculator {
    ...
    SkippedItemsResponse getSkippedItemsResponse() {
        ...
        SkippedItemsResponseBuilder builder =
            new SkippedItemsResponseBuilder(skippedUnits, skippedLessons, skippedAssessments, skippedCollections,
                skippedAssessmentsExternal, skippedCollectionsExternal);
