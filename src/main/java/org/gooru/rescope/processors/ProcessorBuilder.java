...
public final class ProcessorBuilder {
    ...
    public static AsyncMessageProcessor buildFetchRescopedContentProcessor(Vertx vertx, Message<JsonObject> message) {
        return new FetchRescopedContentProcessor(vertx, message);
    }

    public static AsyncMessageProcessor buildDoRescopeOfContentProcessor(Vertx vertx, Message<JsonObject> message) {
